...
describe('Wizard tests', function () {
    ...
    wizard.setForm(_formWIthNestedWizard["default"]).then(function () {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          clickWizardBtn('submit');
          setTimeout(function () {
            _powerAssert["default"].equal(wizard.refs.errorRef.length, 3, 'Should have errors');
            wizard.refs.errorRef[0].dispatchEvent(clickEvent);
            setTimeout(function () {
              checkPage(2);
  ...
  it('Should stay on current page when changing language', function (done) {
    ...
    wizard.setForm(_wizardTestForm["default"].form).then(function () {
      var checkPage = function checkPage(page) {
        _powerAssert["default"].equal(wizard.page, page, "Page ".concat(page + 1, " should be the current page"));
      };
      _harness["default"].clickElement(wizard, wizard.refs["".concat(wizard.wizardKey, "-link")][2]);
      checkPage(2);
      wizard.language = 'es';
      setTimeout(function () {
        checkPage(2);
