  ...
  _createClass(Wizard, [
    ...
    },
    {
      ...
      get: function get() {
        ...
        return (
          ((_this$pages$this$page = this.pages[this.page]) === null ||
          _this$pages$this$page === void 0
            ? void 0
            : (_this$pages$this$page2 = _this$pages$this$page.root) === null ||
              _this$pages$this$page2 === void 0
            ? void 0
            : _this$pages$this$page2.submission.data) || this.submission.data
        );
      },
    },
    {
      ...
      value: function checkConditions(data, flags, row) {
        var visible = _get(
          _getPrototypeOf(Wizard.prototype),
          "checkConditions",
          this
        ).call(this, data, flags, row);
    ...
    },
    {
      ...
      value: function getComponents() {
        return this.submitting
          ...
          : _get(_getPrototypeOf(Wizard.prototype), "getComponents", this).call(
              this
            );
      },
    },
    ...
    },
    {
      ...
      value: function init() {
        ...
        this.options.buttonSettings = _lodash["default"].defaults(
        ...
        if (!this.isSecondInit) {
          ...
          this.isClickableDefined =
            (_this$options = this.options) === null || _this$options === void 0
              ? void 0
              : (_this$options$breadcr = _this$options.breadcrumbSettings) ===
                  null || _this$options$breadcr === void 0
              ? void 0
              : _this$options$breadcr.hasOwnProperty("clickable");
          this.isSecondInit = true;
        }
        this.options.breadcrumbSettings = _lodash["default"].defaults(
          this.options.breadcrumbSettings,
          {
            clickable: true,
          }
        );
        ...
        if (
          (_this$pages = this.pages) !== null &&
          _this$pages !== void 0 &&
          _this$pages[this.page]
        ) {
        ...
        this.on("subWizardsUpdated", function (subForm) {
          var subWizard = _this4.subWizards.find(function (subWizard) {
            ...
            return (
              (subForm === null || subForm === void 0 ? void 0 : subForm.id) &&
              ((_subWizard$subForm = subWizard.subForm) === null ||
              _subWizard$subForm === void 0
                ? void 0
                : _subWizard$subForm.id) ===
                (subForm === null || subForm === void 0 ? void 0 : subForm.id)
            );
          });
    ...
    },
    {
      ...
      get: function get() {
        var _this$options$propert,
          ...
          _this$options$propert3;
        var defaultButtonOrder = ["cancel", "previous", "next", "submit"];
        return (_this$options$propert =
          (_this$options$propert2 = this.options.properties) === null ||
          _this$options$propert2 === void 0
            ? void 0
            : (_this$options$propert3 =
                _this$options$propert2.wizardButtonOrder) === null ||
              _this$options$propert3 === void 0
            ? void 0
            : _this$options$propert3.toLowerCase().split(", ")) !== null &&
          _this$options$propert !== void 0
          ? _this$options$propert
          : defaultButtonOrder;
      },
    },
    {
        ...
        return {
          ...
          isSubForm:
            ...
            !(
              ...
              _this$root !== void 0 &&
              (_this$root$component = _this$root.component) !== null &&
              _this$root$component !== void 0 &&
              _this$root$component.type
            ) === "wizard",
          panels: this.allPages.length
            ? this.allPages.map(function (page) {
        ...
        if (currentPanel && currentPanel.buttonSettings) {
          Object.keys(currentPanel.buttonSettings).forEach(function () {
            Object.keys(ctx.buttons).forEach(function (key) {
              if (
                (typeof currentPanel.buttonSettings[key] !== "undefined" &&
    ...
    },
    {
      ...
      value: function prepareHeaderSettings(ctx, headerType) {
        if (
          (this.currentPanel && this.currentPanel.breadcrumb === "none") ||
          ctx.isSubForm
        ) {
          return null;
        }
    ...
    },
    {
      ...
      value: function render() {
        ...
        var wizardHeaderType = "wizardHeader".concat(
          _lodash["default"].get(this.form, "settings.wizardHeaderType", "")
        );
        var wizardHeaderLocation = _lodash["default"].get(
          this.form,
          "settings.wizardHeaderLocation",
          "left"
        );
          ...
          _objectSpread(
            ...
            {},
            {
              ...
              components: this.renderComponents(
                [].concat(
                  _toConsumableArray(this.prefixComps),
                  _toConsumableArray(this.currentPage.components),
                  _toConsumableArray(this.suffixComps)
                )
              ),
            }
          ),
    ...
    },
    {
      ...
      value: function redrawNavigation() {
        if (this.element) {
          var navElement = this.element.querySelector(
            "#".concat(this.wizardKey, "-nav")
          );
          if (navElement) {
            var _this$loadRefs;
            this.detachNav();
            navElement.outerHTML = this.renderTemplate(
              "wizardNav",
              this.renderContext
            );
            ...
            this.loadRefs(
              ...
              _defineProperty(
                _this$loadRefs,
                "".concat(this.wizardKey, "-cancel"),
                "single"
              ),
              _defineProperty(
                _this$loadRefs,
                "".concat(this.wizardKey, "-previous"),
                "single"
              ),
              _defineProperty(
                _this$loadRefs,
                "".concat(this.wizardKey, "-next"),
                "single"
              ),
              _defineProperty(
                _this$loadRefs,
                "".concat(this.wizardKey, "-submit"),
                "single"
              ),
              _this$loadRefs)
            );
    ...
    },
    {
      ...
      value: function redrawHeader() {
        if (this.element) {
          var headerElement = this.element.querySelector(
            "#".concat(this.wizardKey, "-header")
          );
          if (headerElement) {
            var _this$loadRefs2;
            this.detachHeader();
            headerElement.outerHTML = this.renderTemplate(
              "wizardHeader".concat(
                _lodash["default"].get(
                  this.form,
                  "settings.wizardHeaderType",
                  ""
                )
              ),
              this.renderContext
            ...
            this.loadRefs(
              ...
              _defineProperty(
                _this$loadRefs2,
                "".concat(this.wizardKey, "-link"),
                "multiple"
              ),
              _defineProperty(
                _this$loadRefs2,
                "".concat(this.wizardKey, "-tooltip"),
                "multiple"
              ),
              _this$loadRefs2)
            );
    ...
    },
    {
      ...
      value: function attach(element) {
        ...
        this.loadRefs(
          element,
          ((_this$loadRefs3 = {}),
          _defineProperty(_this$loadRefs3, this.wizardKey, "single"),
          _defineProperty(
            _this$loadRefs3,
            "".concat(this.wizardKey, "-header"),
            "single"
        ...
        if ((this.options.readOnly || this.editMode) && !this.enabledIndex) {
          var _this$pages2;
          this.enabledIndex =
            ((_this$pages2 = this.pages) === null || _this$pages2 === void 0
              ? void 0
              : _this$pages2.length) - 1;
        }
        this.hook("attachWebform", element, this);
        var promises = this.attachComponents(
          this.refs[this.wizardKey],
          [].concat(
            _toConsumableArray(this.prefixComps),
            _toConsumableArray(this.currentPage.components),
            _toConsumableArray(this.suffixComps)
    ...
    },
    {
      ...
      value: function scrollPageToTop() {
        var _this$refs;
        var pageTop =
          (_this$refs = this.refs["".concat(this.wizardKey, "-header")]) !==
            null && _this$refs !== void 0
            ? _this$refs
            : this.refs[this.wizardKey];
        if (!pageTop) {
          return;
    ...
    },
    {
      ...
      value: function isBreadcrumbClickable() {
        ...
        return this.isClickableDefined
          ? this.options.breadcrumbSettings.clickable
          : _lodash["default"].get(
              currentPage,
              "component.breadcrumbClickable",
              true
            );
      },
    },
    ...
    },
    {
      ...
      value: function handleNaviageteOnEnter(event) {
        if (event.keyCode === 13) {
          ...
          var buttonElement =
            this.refs[
              "".concat(this.wizardKey, "-").concat(this.buttons.next.name)
            ];
          if (buttonElement) {
    ...
    },
    {
      ...
      value: function handleSaveOnEnter(event) {
        if (event.keyCode === 13) {
          ...
          var buttonElement =
            this.refs[
              "".concat(this.wizardKey, "-").concat(this.buttons.submit.name)
            ];
          if (buttonElement) {
            buttonElement.dispatchEvent(clickEvent);
          }
      ...
      value: function attachNav() {
        ...
        if (this.component.navigateOnEnter) {
          this.addEventListener(
            document,
            "keyup",
            this.handleNaviageteOnEnter.bind(this)
          );
        }
        if (this.component.saveOnEnter) {
          this.addEventListener(
            document,
            "keyup",
            this.handleSaveOnEnter.bind(this)
          );
        }
        _lodash["default"].each(this.buttons, function (button) {
          var buttonElement =
            _this10.refs["".concat(_this10.wizardKey, "-").concat(button.name)];
    ...
    },
    {
      ...
      value: function attachHeader() {
        ...
        this.attachTooltips(
          this.refs["".concat(this.wizardKey, "-tooltip")],
          this.currentPanel.tooltip
        );
        if (this.isBreadcrumbClickable() || isAllowPrevious) {
          var _this$refs2;
          (_this$refs2 = this.refs["".concat(this.wizardKey, "-link")]) ===
            null || _this$refs2 === void 0
            ? void 0
            : _this$refs2.forEach(function (link, index) {
                if (!isAllowPrevious || index <= _this11.enabledIndex) {
                  _this11.addEventListener(link, "click", function (event) {
                    _this11.emit(
                      "wizardNavigationClicked",
                      _this11.pages[index]
                    );
                    event.preventDefault();
    ...
    },
    {
      ...
      value: function detachNav() {
        ...
        _lodash["default"].each(this.buttons, function (button) {
          _this12.removeEventListener(
            _this12.refs["".concat(_this12.wizardKey, "-").concat(button.name)],
            "click"
          );
        });
      },
    },
    {
      ...
      value: function detachHeader() {
        ...
        if (this.refs["".concat(this.wizardKey, "-link")]) {
          this.refs["".concat(this.wizardKey, "-link")].forEach(function (
            link
          ) {
      ...
      value: function transformPages() {
        ...
        var getAllComponents = function getAllComponents(nestedComp, compsArr) {
          ...
          var currentComponents =
            nestedComp !== null && nestedComp !== void 0 && nestedComp.subForm
              ? _this14.getSortedComponents(nestedComp.subForm)
              : (nestedComp === null || nestedComp === void 0
                  ? void 0
          ...
          var filteredComponents = visibleComponents.filter(function (comp) {
            return (
              !dataArrayComponents.includes(comp.component.type) &&
          ...
          var additionalComponents = currentComponents.filter(function (comp) {
            var _comp$subForm;
            return (
              ((_comp$subForm = comp.subForm) === null ||
              _comp$subForm === void 0
                ? void 0
                : _comp$subForm._form.display) !== "wizard"
            );
          });
          var hasNested = false;
          (0, _utils.eachComponent)(
            filteredComponents,
            function (comp) {
              if (comp && comp.component) {
                if (
                  comp.component.type === "panel" &&
                  comp !== null &&
                  comp !== void 0 &&
                  comp.parent.wizard &&
                ...
                if (comp.isNestedWizard && comp.subForm) {
                  var hasNestedForm = getAllComponents(
                    comp,
                    nestedPages,
                    pushAllowed
                  );
          ...
          if (pushAllowed) {
            compsArr.push.apply(
              compsArr,
              _toConsumableArray(defferedComponents).concat(nestedPages)
            );
            defferedComponents = [];
          }
          return hasNested;
    ...
    },
    {
      ...
      value: function getSortedComponents(_ref) {
        ...
        originalComponents === null || originalComponents === void 0
          ? void 0
          : originalComponents.forEach(function (item) {
              if (!item.key) {
                item.key = item.title;
              }
    ...
    },
    {
      ...
      value: function findRootPanel(component) {
        ...
        return (_component$parent = component.parent) !== null &&
          _component$parent !== void 0 &&
          _component$parent.parent
          ? this.findRootPanel(component.parent)
          : component;
      },
    },
    {
      ...
      value: function setRootPanelId(component) {
        ...
        var parent =
          (_component$parent2 = component.parent) !== null &&
          _component$parent2 !== void 0 &&
          _component$parent2.parent
            ? this.findRootPanel(component.parent)
            : component;
    ...
    },
    {
      ...
      value: function establishPages() {
        ...
        var visible = [];
        var currentPages = {};
        var pageOptions = _objectSpread(
          _objectSpread({}, _lodash["default"].clone(this.options)),
          this.parent
            ? {
                root: this,
              }
          ...
          this.originalComponents.forEach(function (item) {
            if (item.type === "panel") {
              ...
              if (!_this15.pages.length) {
                _this15.prefixComps.push(
                  _this15.createComponent(item, pageOptions)
                );
              } else {
                _this15.suffixComps.push(
                  _this15.createComponent(item, pageOptions)
                );
              }
            }
      ...
      value: function setPage(num) {
        ...
        if (num >= 0 && num < this.pages.length) {
          ...
          if (this.hasExtraPages) {
            ...
            if (
              !pageFromComponents ||
              (pageFromPages === null || pageFromPages === void 0
                ? void 0
                : pageFromPages.id) !== pageFromComponents.id
            ) {
              parentNum = this.components.findIndex(function (comp) {
                var _this16$pages, _this16$pages$parentN;
                return (
                  comp.id ===
                  ((_this16$pages = _this16.pages) === null ||
                  _this16$pages === void 0
                    ? void 0
                    : (_this16$pages$parentN = _this16$pages[parentNum]) ===
                        null || _this16$pages$parentN === void 0
                    ? void 0
                    : _this16$pages$parentN.rootPanelId)
                );
              });
            }
          }
    ...
    },
    {
      ...
      value: function getNextPage() {
        var _this$pages4;
        if (
          (_this$pages4 = this.pages) !== null &&
          _this$pages4 !== void 0 &&
          _this$pages4[this.page]
        ) {
          ...
          if (form) {
            var page =
              this.pages.length > this.page + 1 && !this.showAllErrors
                ? this.page + 1
                : -1;
            if (form.nextPage) {
              var next = this.evaluate(
                form.nextPage,
                {
                  next: page,
                  data: data,
    ...
    },
    {
      ...
      value: function beforeSubmit() {
        ...
        return _nativePromiseOnly["default"].all(
      ...
      value: function nextPage() {
        ...
        if (this.checkValidity(this.localData, true, this.localData, true)) {
          ...
          return this.beforePage(true).then(function () {
            return _this18.setPage(_this18.getNextPage()).then(function () {
              if (
                !(_this18.options.readOnly || _this18.editMode) &&
    ...
    },
    {
      ...
      value: function cancel(noconfirm) {
        ...
        if (
          _get(_getPrototypeOf(Wizard.prototype), "cancel", this).call(
            this,
            noconfirm
          )
        ) {
        ...
        this.component.components.map(function (item) {
          if (item.type === "panel") {
            ...
            if (_this21.wizard.full) {
              ...
              _this21.wizard.hasOwnProperty("full") &&
              !_lodash["default"].isEqual(
                _this21.originalOptions.show,
                _this21.options.show
              )
            ) {
              _this21.options.show = _objectSpread(
                {},
                _this21.originalOptions.show || {}
              );
            }
    ...
    },
    {
      ...
      value: function setForm(form, flags) {
        ...
        return _get(_getPrototypeOf(Wizard.prototype), "setForm", this).call(
          this,
          form,
          flags
        );
    ...
    },
    {
      ...
      value: function onSetForm(clonedForm, initialForm) {
        this.component.components =
          (this._parentPath ? initialForm.components : clonedForm.components) ||
          [];
        this.setComponentSchema();
      },
    },
      ...
      value: function setValue(submission) {
        ...
        var flags =
          arguments.length > 1 && arguments[1] !== undefined
            ? arguments[1]
            : {};
        var ignoreEstablishment =
          arguments.length > 2 ? arguments[2] : undefined;
        var changed = this.getPages({
          all: true,
        }).reduce(function (changed, page) {
          return (
            _this22.setNestedValue(page, submission.data, flags, changed) ||
            changed
          );
        }, false);
    ...
    },
    {
      ...
      value: function isClickable(page, index) {
        return (
          this.page !== index &&
          (0, _utils.firstNonNil)([
            _lodash["default"].get(page, "breadcrumbClickable"),
            this.options.breadcrumbSettings.clickable,
          ])
        );
      },
    ...
    },
    {
      ...
      value: function onChange(flags, changed, modified, changes) {
        var _this23 = this;
        _get(_getPrototypeOf(Wizard.prototype), "onChange", this).call(
          this,
          flags,
          changed,
          modified,
        ...
        if (this.hasExtraPages) {
          ...
          if (
            (_this$currentPanel = this.currentPanel) !== null &&
            _this$currentPanel !== void 0 &&
            _this$currentPanel.key &&
            (_this$currentPanels = this.currentPanels) !== null &&
            _this$currentPanels !== void 0 &&
            _this$currentPanels.length
          ) {
            this.setPage(
              this.currentPanels.findIndex(function (panel) {
        ...
        if (
          !_lodash["default"].isEqual(panels, currentPanels) ||
          (flags && flags.fromSubmission)
        ) {
          this.redrawHeader();
        }
        ...
        if (
          this.options.readOnly &&
          (this.prefixComps.length || this.suffixComps.length)
        ) {
          this.redraw();
        }
      },
    },
    {
      ...
      value: function redraw() {
        ...
        if (
          ...
          _this$parent !== void 0 &&
          (_this$parent$componen = _this$parent.component) !== null &&
          _this$parent$componen !== void 0 &&
          _this$parent$componen.modalEdit
        ) {
          return this.parent.redraw();
        }
        return _get(_getPrototypeOf(Wizard.prototype), "redraw", this).call(
          this
        );
      },
    },
    {
      ...
      value: function rebuild() {
        ...
        return _get(_getPrototypeOf(Wizard.prototype), "rebuild", this)
          .call(this)
          .then(setCurrentPage);
      },
    },
    {
      ...
      value: function checkValidity(data, dirty, row, currentPageOnly) {
        ...
        var components =
          !currentPageOnly || this.isLastPage()
            ? this.getComponents()
      ...
      value: function focusOnComponent(key) {
        ...
        if (page && page !== this.currentPage) {
          return this.setPage(pageIndex).then(function () {
            _this25.checkValidity(
              _this25.submission.data,
              true,
              _this25.submission.data
            );
            _this25.showErrors();
