...
var _Component2 = _interopRequireDefault(
  require("./components/_classes/component/Component")
);
...
var WebformBuilder = /*#__PURE__*/ (function (_Component) {
  ...
  function WebformBuilder() {
    ...
    _this.sideBarScroll = _lodash["default"].get(
      _this.options,
      "sideBarScroll",
      true
    );
    _this.sideBarScrollOffset = _lodash["default"].get(
      _this.options,
      "sideBarScrollOffset",
      0
    );
    ...
    _this.builder = _lodash["default"].defaultsDeep(
      {},
      _this.options.builder,
      _this.defaultGroups
    );
    ...
    var _loop = function _loop(group) {
      if (_this.builder[group]) {
        ...
        _this.groups[group].componentOrder =
          _this.groups[group].componentOrder || [];
        _this.groups[group].subgroups = Object.keys(
          _this.groups[group].groups || {}
        ).map(function (groupKey) {
          _this.groups[group].groups[groupKey].componentOrder = Object.keys(
            _this.groups[group].groups[groupKey].components
          ).map(function (key) {
            return key;
          });
    ...
    for (var _group in _this.groups) {
      ...
      for (var key in info.components) {
        ...
        if (
          comp === true &&
          _Components["default"].components[key] &&
          _Components["default"].components[key].builderInfo
        ) {
    ...
    _this.options.hooks.renderComponent = function (html, _ref) {
      ...
      if (
        (_this.options.disabled && _this.options.disabled.includes(self.key)) ||
      ...
      return _this.renderTemplate("builderComponent", {
        html: html,
        disableBuilderActions:
          self === null || self === void 0
            ? void 0
            : (_self$component = self.component) === null ||
              _self$component === void 0
            ? void 0
            : _self$component.disableBuilderActions,
        childComponent: component,
        design:
          self === null || self === void 0
            ? void 0
            : (_self$options = self.options) === null ||
              _self$options === void 0
            ? void 0
            : _self$options.design,
      });
    };
    _this.options.hooks.renderComponents = function (html, _ref2) {
      ...
      if (
        (self.type === "datagrid" && components.length > 0) ||
        self.noDragDrop
      ) {
        return html;
      }
      if (
        ...
        html =
          _this.renderTemplate("builderPlaceholder", {
            position: 0,
          }) + html;
      }
    ...
    _this.options.hooks.attachComponents = function (
      element,
      components,
      container,
      component
      ...
      var containerElement =
        element.querySelector(
          '[ref="'.concat(component.component.key, '-container"]')
        ) || element;
    ...
    _this.options.hooks.attachDatagrid = function (element, component) {
      component.loadRefs(
        element,
        _defineProperty({}, "".concat(component.key, "-container"), "single")
      );
      var dataGridContainer =
        component.refs["".concat(component.key, "-container")];
    ...
    _this.options.hooks.attachComponent = _this.attachComponent.bind(
    ...
    var isResourcesDisabled =
      _this.options.builder && _this.options.builder.resource === false;
    formio
      .loadProject()
      .then(function (project) {
        if (
          ...
          (_lodash["default"].get(
            project,
            "settings.addConfigToForms",
            false
          ) ||
            _lodash["default"].get(project, "addConfigToForms", false))
        ) {
          var config = project.config || {};
          _this.options.formConfig = config;
          var pathToFormConfig = "webform._form.config";
          var webformConfig = _lodash["default"].get(
            _assertThisInitialized(_this),
            pathToFormConfig
          );
  ...
  _createClass(WebformBuilder, [
    ...
    },
    {
      ...
      value: function addExistingResourceFields(resources) {
        ...
        _lodash["default"].each(resources, function (resource, index) {
          ...
          (0, _formUtils.eachComponent)(
            resource.components,
            function (component) {
              if (component.type === "button") return;
              if (
                _this2.options &&
                _this2.options.resourceFilter &&
                (!component.tags ||
                  component.tags.indexOf(_this2.options.resourceFilter) === -1)
              )
                return;
              ...
              subgroup.components["component-".concat(component.key)] = _lodash[
                "default"
              ].merge(
                (0, _utils.fastCloneDeep)(
                  _Components["default"].components[component.type]
                    ? _Components["default"].components[component.type]
                        .builderInfo
                    : _Components["default"].components["unknown"].builderInfo
                ),
                {
                  key: component.key,
                  title: componentName,
                ...
                },
                {
                  schema: _objectSpread(
                    ...
                    {},
                    {
                      ...
                      key: component.key,
                      lockKey: true,
                      source: !_this2.options.noSource
                        ? resource._id
                        : undefined,
                      isNew: true,
                    }
    ...
    },
    {
      ...
      value: function attachComponent(element, component) {
        ...
        if (component.refs.pasteComponent) {
          var pasteToolTip = this.attachTooltip(
    ...
    },
    {
      ...
      value: function findNamespaceRoot(component) {
        ...
        if (namespaceKey === component.key) {
          return [].concat(_toConsumableArray(componentSchema.components), [
            componentSchema,
          ]);
        }

        // Get the namespace component so we have the original object.
        var namespaceComponent = (0, _formUtils.getComponent)(
          this.form.components,
          namespaceKey,
          true
        );
        return namespaceComponent
          ? namespaceComponent.components
          : comp.components;
      },
    },
    {
          ...
          sidebar: this.renderTemplate("builderSidebar", {
            ...
            groups: this.groupOrder.map(function (groupKey) {
              return _this4.renderTemplate("builderSidebarGroup", {
                ...
                subgroups: _this4.groups[groupKey].subgroups.map(function (
                  group
                ) {
                  return _this4.renderTemplate("builderSidebarGroup", {
                    group: group,
    ...
    },
    {
      ...
      value: function attach(element) {
        ...
        return _get(_getPrototypeOf(WebformBuilder.prototype), "attach", this)
          .call(this, element)
          .then(function () {
            ...
            if (
              _this5.sideBarScroll &&
              Templates.current.handleBuilderSidebarScroll
            ) {
            ...
            if (!(0, _utils.bootstrapVersion)(_this5.options)) {
              ...
              _this5.refs["sidebar-anchor"].forEach(function (anchor, index) {
                _this5.addEventListener(
                  ...
                  "click",
                  function () {
                    var clickedParentId = anchor
                      .getAttribute("data-parent")
                      .slice("#builder-sidebar-".length);
                    var clickedId = anchor
                      .getAttribute("data-target")
                      .slice("#group-".length);
                    _this5.refs["sidebar-group"].forEach(function (
                      group,
                      groupIndex
                    ) {
                      var openByDefault =
            ...
            _this5.addEventListener(
              _this5.refs["sidebar-search"],
              "input",
              _lodash["default"].debounce(function (e) {
      ...
      value: function searchFields() {
        ...
        var filterGroupBy = function filterGroupBy(group) {
          ...
          for (var key in components) {
            var isMatchedToTitle = components[key].title
              .toLowerCase()
              .match(searchValue);
            var isMatchedToKey = components[key].key
              .toLowerCase()
              .match(searchValue);
        ...
        var filterGroupOrder = function filterGroupOrder(
          groupOrder,
          searchValue
        ) {
        ...
        var toTemplate = function toTemplate(groupKey) {
          return {
            ...
            subgroups: filterSubgroups(
              _this6.groups[groupKey].subgroups,
              searchValue
            ).map(function (group) {
        ...
        if (components) {
          groupInfo.componentOrder = Object.keys(components)
            ...
            .map(function (component) {
              return isResource
                ? "component-".concat(component.key)
                : component.key;
            });
        }
      },
    ...
    },
    {
      ...
      value: function initDragula() {
        ...
        var containersArray = Array.prototype.slice
        ...
        this.dragula = dragula(containersArray, {
          ...
          accepts: function accepts(el, target) {
            return (
              !el.contains(target) && !target.classList.contains("no-drop")
            );
          },
    ...
    },
    {
      ...
      value: function detach() {
        ...
        _get(_getPrototypeOf(WebformBuilder.prototype), "detach", this).call(
          this
        );
      },
    },
    {
      ...
      value: function getComponentInfo(key, group) {
        ...
        if (group && group.slice(0, group.indexOf("-")) === "resource") {
          ...
          if (
            resourceGroup &&
            resourceGroup.components.hasOwnProperty("component-".concat(key))
          ) {
            info = (0, _utils.fastCloneDeep)(
              resourceGroup.components["component-".concat(key)].schema
            );
          }
        }
        // This is a new component
          ...
          for (var ix = 0; ix < _resourceGroups.length; ix++) {
            ...
            if (
              _resourceGroup.components.hasOwnProperty("component-".concat(key))
            ) {
              info = (0, _utils.fastCloneDeep)(
                _resourceGroup.components["component-".concat(key)].schema
              );
              break;
            }
          }
    ...
    },
    {
      ...
      value: function getComponentsPath(component, parent) {
        ...
        switch (parent.type) {
          case "table":
            tableRowIndex = _lodash["default"].findIndex(
              parent.rows,
              function (row) {
            ...
            tableColumnIndex = _lodash["default"].findIndex(
              parent.rows[tableRowIndex],
              function (column) {
                return column.components.some(function (comp) {
                  return comp.key === component.key;
                });
            ...
            path = "rows["
              .concat(tableRowIndex, "][")
              .concat(tableColumnIndex, "].components");
            break;
          case "columns":
            columnIndex = _lodash["default"].findIndex(
              parent.columns,
              function (column) {
                return column.components.some(function (comp) {
                  return comp.key === component.key;
            ...
            break;
          case "tabs":
            tabIndex = _lodash["default"].findIndex(
              parent.components,
              function (tab) {
    ...
    },
    {
      ...
      value: function onDrop(element, target, source, sibling) {
        ...
        if (key && group) {
          ...
          if (index !== -1) {
            ...
            info = source.formioContainer.splice(
              _lodash["default"].findIndex(source.formioContainer, {
                key: element.formioComponent.component.key,
              }),
              1
            );
        ...
        var draggableComponent =
          ((_this$groups$group = this.groups[group]) === null ||
          _this$groups$group === void 0
            ? void 0
            : _this$groups$group.components[compKey]) || {};
        if (draggableComponent.disableSiblings) {
          ...
          if (isCompAlreadyExists) {
            ...
            this.webform.setAlert(
              "danger",
              "You cannot add more than one ".concat(
                draggableComponent.key,
        ...
        if (target !== source) {
          ...
          _builder["default"].uniquify(
            this.findNamespaceRoot(target.formioComponent),
            info
          );
        }
        ...
        if (target.formioContainer) {
          if (sibling) {
            if (!sibling.getAttribute("data-noattach")) {
              index = _lodash["default"].findIndex(target.formioContainer, {
                key: _lodash["default"].get(
                  sibling,
                  "formioComponent.component.key"
                ),
              });
          ...
          index = _lodash["default"].findIndex(
            _lodash["default"].get(parent.schema, path),
            {
              key: info.key,
            }
          );
        ...
        return rebuild.then(function () {
          _this8.emit(
            ...
            path,
            index,
            isNew && !_this8.options.noNewEdit && !info.noNewEdit
          );
    ...
    },
    {
      ...
      value: function setForm(form) {
        ...
        this.keyboardActionsEnabled =
          _lodash["default"].get(this.options, "keyboardBuilder", false) ||
          ((_this$options$propert = this.options.properties) === null ||
          _this$options$propert === void 0
            ? void 0
            : _this$options$propert.keyboardBuilder);
        var isShowSubmitButton =
      ...
      value: function populateCaptchaSettings(form) {
        ...
        if (this.form.components) {
          ...
          if (isCaptchaEnabled) {
            ...
            _lodash["default"].get(form, "settings.captcha.isEnabled")
          ) {
    ...
    },
    {
      ...
      value: function removeComponent(
        ...
        if (
          this.options.alwaysConfirmComponentRemoval ||
          removingComponentsGroup
        ) {
          var message = removingComponentsGroup
        ...
        var index = parent.formioContainer
          ? parent.formioContainer.indexOf(original)
          : 0;
        if (remove && index !== -1) {
          var path = this.getComponentsPath(
            component,
          ...
          var rebuild =
            ...
            _nativePromiseOnly["default"].resolve();
    ...
    },
    {
      ...
      value: function replaceDoubleQuotes(data) {
        var fieldsToRemoveDoubleQuotes =
          arguments.length > 1 && arguments[1] !== undefined
            ? arguments[1]
            : [];
        if (data) {
    ...
    },
    {
      ...
      value: function updateComponent(component, changed) {
        ...
        var sanitizeConfig =
          _lodash["default"].get(
            this.webform,
            "form.settings.sanitizeConfig"
          ) ||
          _lodash["default"].get(
            this.webform,
            "form.globalSettings.sanitizeConfig"
          );
        // Update the preview.
        if (this.preview) {
          this.preview.form = {
            components: [
              _lodash["default"].omit(_objectSpread({}, component), [
                "hidden",
                "conditional",
                "calculateValue",
                "logic",
          ...
          this.preview.form.components.forEach(function (component) {
            return _this11.replaceDoubleQuotes(
              component,
              fieldsToRemoveDoubleQuotes
            );
          });
          var previewElement =
            this.componentEdit.querySelector('[ref="preview"]');
          if (previewElement) {
            this.setContent(
              previewElement,
              this.preview.render(),
        ...
        var defaultValueComponent = (0, _formUtils.getComponent)(
          this.editForm.components,
          "defaultValue",
          true
        );
        if (defaultValueComponent && component.type !== "hidden") {
          ...
          if (!defaultChanged) {
            ...
            var path = (0, _utils.getArrayFromComponentPath)(
          ...
          function (comp, path) {
            ...
            if (keys.has(comp.key)) {
              if (keys.get(comp.key).includes(path)) {
                ...
                keys.set(
                  comp.key,
                  [].concat(_toConsumableArray(keys.get(comp.key)), [path])
                );
              }
            } else {
      ...
      value: function highlightInvalidComponents() {
        ...
        this.webform.everyComponent(function (comp) {
          ...
          if (repeatablePaths.includes(path)) {
            ...
            (_comp$error = comp.error) !== null &&
            _comp$error !== void 0 &&
            (_comp$error$message = _comp$error.message) !== null &&
            _comp$error$message !== void 0 &&
            _comp$error$message.startsWith("API Key is not unique")
          ) {
    ...
    },
    {
      ...
      value: function saveComponent(component, parent, isNew, original) {
        ...
        if (index !== -1) {
          ...
          var isParentSaveChildMethod = this.isParentSaveChildMethod(
            parent.formioComponent
          );
          ...
          var rebuild =
            ...
            _nativePromiseOnly["default"].resolve();
          return rebuild.then(function () {
            var schema = parentContainer
              ? parentContainer[index]
              : comp
              ? comp.schema
              : [];
            _this12.emitSaveComponentEvent(
              schema,
              originalComp,
    ...
    },
    {
      ...
      value: function emitSaveComponentEvent(
        schema,
        originalComp,
    ...
    },
    {
      ...
      value: function attachEditComponentControls(
        component,
        parent,
        isNew,
        original,
        ...
        var _this13 = this;
        var cancelButtons = this.componentEdit.querySelectorAll(
          '[ref="cancelButton"]'
        );
        cancelButtons.forEach(function (cancelButton) {
          _this13.editForm.addEventListener(
            cancelButton,
            "click",
            function (event) {
        ...
        var removeButtons = this.componentEdit.querySelectorAll(
          '[ref="removeButton"]'
        );
        ...
        var saveButtons =
          this.componentEdit.querySelectorAll('[ref="saveButton"]');
        saveButtons.forEach(function (saveButton) {
          _this13.editForm.addEventListener(
            ...
            function (event) {
              event.preventDefault();
              if (
                !_this13.editForm.checkValidity(
                  _this13.editForm.data,
                  true,
                  _this13.editForm.data
                )
              ) {
        ...
        var previewButtons = this.componentEdit.querySelectorAll(
          '[ref="previewButton"]'
        );
        previewButtons.forEach(function (previewButton) {
          _this13.editForm.addEventListener(
            ...
            function (event) {
              ...
              _this13.editForm.detach();
              _this13.setContent(
                _this13.componentEdit,
                _this13.renderTemplate("builderEditForm", {
              ...
              _this13.editForm.attach(
                _this13.componentEdit.querySelector('[ref="editForm"]')
              );
              _this13.attachEditComponentControls(
                component,
                parent,
                isNew,
                original,
    ...
    },
    {
      ...
      value: function editComponent(
        ...
        var editFormOptions = _lodash["default"].clone(
          _lodash["default"].get(this, "options.editForm", {})
        );
        if (this.editForm) {
        ...
        var overrides = _lodash["default"].get(
          this.options,
          "editForm.".concat(componentCopy.type),
          {}
        );
        ...
        this.editForm = new _Webform["default"](
          _objectSpread(
            _objectSpread(
              {},
              _lodash["default"].omit(this.options, [
                "hooks",
                "builder",
                "events",
                "attachMode",
        ...
        if (
          ...
          this.preview = new _Webform["default"](
            _lodash["default"].omit(
              _objectSpread(
        ...
        this.showPreview =
          (_ComponentClass$build = ComponentClass.builderInfo.showPreview) !==
            null && _ComponentClass$build !== void 0
            ? _ComponentClass$build
            : true;
        ...
        this.dialog = this.createModal(
          this.componentEdit,
          _lodash["default"].get(this.options, "dialogAttr", {})
        );
          ...
          if (event.changed) {
            ...
            if (isComponentLabelChanged) {
              ...
              if (isNew) {
                if (!event.data.keyModified) {
                  _this14.editForm.everyComponent(function (component) {
                    if (
                      ...
                      component.setValue(
                        _this14.updateComponentKey(event.data)
                      );
                      return false;
                    }
                  });
                ...
                if (_this14.form) {
                  var formComponents = _this14.findNamespaceRoot(
                    parent.formioComponent
                  );
    ...
    },
    {
      ...
      value: function updateComponentKey(data) {
        return _lodash["default"]
          .camelCase(data.title || data.label || data.placeholder || data.type)
          .replace(/^[0-9]*/, "");
      },
    },
    {
      ...
      value: function moveComponent(component) {
        if (this.selectedComponent) {
          ...
          (_prevSelected$element = prevSelected.element) === null ||
          _prevSelected$element === void 0
            ? void 0
            : _prevSelected$element.classList.remove(
      ...
      value: function updateComponentPlacement(direction) {
        ...
        if (component) {
          ...
          if (index === -1) {
            ...
            index = _lodash["default"].findIndex(
              source.formioComponent.components,
              {
                key: key,
              }
            );
    ...
    },
    {
      ...
      value: function addNewComponent(element) {
        ...
        if (isNew && !this.options.noNewEdit && !info.noNewEdit) {
          _builder["default"].uniquify(
            this.findNamespaceRoot(source.formioComponent),
            info
          );
          this.editComponent(info, source, isNew, null, null);
        }
        var firstComponent =
          (_source$formioCompone = source.formioComponent.components[0]) ===
            null || _source$formioCompone === void 0
            ? void 0
            : _source$formioCompone.element;
        if (firstComponent) {
          source.formioContainer.splice(0, 0, info);
        } else {
          source.formioContainer.push(info);
    ...
    },
    {
      ...
      value: function copyComponent(component) {
        if (!window.sessionStorage) {
          return console.warn(
            "Session storage is not supported in this browser."
          );
        }
    ...
    },
    {
      ...
      value: function init() {
        ...
        return _get(
          _getPrototypeOf(WebformBuilder.prototype),
          "init",
          this
        ).call(this);
      },
    ...
    },
    {
      ...
      value: function destroy(deleteFromGlobal) {
        ...
        _get(_getPrototypeOf(WebformBuilder.prototype), "destroy", this).call(
          this,
          deleteFromGlobal
        );
      },
    ...
    },
    {
      ...
      value: function generateKey(info) {
        return (
          info.key ||
          _lodash["default"].camelCase(
            info.title || info.label || info.placeholder || info.type
          )
        );
      },
    },
