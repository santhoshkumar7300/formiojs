...
describe('Container Component', function () {
  ...
  it('Should not include an array index in any child component paths when child of a nested component', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var form, element, formInstance, editGrid, container, textField;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            form = _lodash["default"].cloneDeep(_fixtures.editGridWithChildContainer);
            element = document.createElement('div');
            _context.next = 4;
            return _Formio["default"].createForm(element, form);
          case 4:
            ...
            _context.next = 8;
            return formInstance.submissionReady;
          case 8:
            editGrid = formInstance.getComponent(['editGrid']);
            (0, _powerAssert["default"])(editGrid, 'EditGrid component found');
            _powerAssert["default"].strictEqual(editGrid.path, 'editGrid');
            container = formInstance.getComponent('container');
            (0, _powerAssert["default"])(container, 'Container component found');
            _powerAssert["default"].strictEqual(container.path, 'editGrid[0].container');
            textField = formInstance.getComponent('textField');
            (0, _powerAssert["default"])(textField, 'TextField component found');
            _powerAssert["default"].strictEqual(textField.path, 'editGrid[0].container.textField');
          case 17:
          case "end":
