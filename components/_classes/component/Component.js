...
var _ComponentModal = _interopRequireDefault(
  require("../componentModal/ComponentModal")
);
...
var Component = /*#__PURE__*/ (function (_Element) {
  ...
  function Component(component, options, data) {
     ...
     * @type {boolean}
     */
    _this._disabled = (0, FormioUtils.boolValue)(_this.component.disabled)
      ? _this.component.disabled
      : false;
     ...
     */
    _this._parentVisible = _this.options.hasOwnProperty("parentVisible")
      ? _this.options.parentVisible
      : true;
    _this._visible =
      _this._parentVisible && _this.conditionallyVisible(null, data);
     ...
     * @type {Function}
     */
    _this.triggerRedraw = _lodash["default"].debounce(
      _this.redraw.bind(_assertThisInitialized(_this)),
      100
    );
    ...
    [
      ...
      },
      {
        ...
        get: function get() {
          ...
          label.tooltipClass = "".concat(
            this.iconClass("question-sign"),
            " text-muted"
          );
          ...
          if (
            ...
            (0, FormioUtils.boolValue)(this.component.validate.required) &&
            !isPDFReadOnlyMode
          ) {
      ...
      },
      {
        ...
        value: function init() {
          ...
          if (
            (_this$component$addon = this.component.addons) !== null &&
            _this$component$addon !== void 0 &&
            _this$component$addon.length
          ) {
      ...
      },
      {
        ...
        value: function createAddon(addonConfiguration) {
          ...
          var settings =
            ((_addonConfiguration$s = addonConfiguration.settings) === null ||
            _addonConfiguration$s === void 0
              ? void 0
              : _addonConfiguration$s.data) || {};
          var Addon = _addons["default"][name.value];
          var addon = null;
          if (Addon) {
            var supportedComponents = Addon.info.supportedComponents;
            var supportsThisComponentType =
              !(
                supportedComponents !== null &&
                supportedComponents !== void 0 &&
                supportedComponents.length
            ...
            if (supportsThisComponentType) {
              ...
              console.warn(
                "Addon "
                  .concat(name.label, " does not support component of type ")
                  .concat(this.component.type, ".")
              );
            }
          }
          return addon;
      ...
      },
      {
        ...
        value: function destroy() {
          _get(_getPrototypeOf(Component.prototype), "destroy", this).call(
            this
          );
          this.detach();
        ...
        get: function get() {
          return (
            ...
            (this.options.hasOwnProperty("disabled") &&
              this.options.disabled[this.key])
          );
        },
      },
      {
        ...
        get: function get() {
          return (
            !this.component.hasOwnProperty("input") || this.component.input
          );
        },
      },
      {
      ...
      },
      {
        ...
        get: function get() {
          return (
            this.isInputComponent || (this.refs.input && this.refs.input.length)
          );
        },
      },
      {
      ...
      },
      {
        ...
        value: function getLabelInfo() {
          ...
          if (this.component.hideLabel) {
            ...
            contentMargin = isRightPosition
              ? "margin-right: ".concat(margin, "%")
              : "";
            contentMargin = isLeftPosition
              ? "margin-left: ".concat(margin, "%")
              : "";
          }
          var labelStyles = "\n      flex: "
            .concat(this.labelWidth, ";\n      ")
            .concat(isRightPosition ? "margin-left" : "margin-right", ": ")
            .concat(this.labelMargin, "%;\n    ");
          var contentStyles = "\n      flex: "
            .concat(100 - this.labelWidth - this.labelMargin, ";\n      ")
            .concat(contentMargin, ";\n      ")
            .concat(
              this.component.hideLabel
                ? "max-width: ".concat(100 - this.labelWidth - this.labelMargin)
                : "",
              ";\n    "
            );
          return {
      ...
      },
      {
        ...
        value: function getModifiedSchema(schema, defaultSchema, recursion) {
          ...
          _lodash["default"].each(schema, function (val, key) {
            if (
              !_lodash["default"].isArray(val) &&
              _lodash["default"].isObject(val) &&
              defaultSchema.hasOwnProperty(key)
            ) {
              var subModified = _this4.getModifiedSchema(
                val,
                defaultSchema[key],
                true
              );
              ...
              if (
                val.length !== 0 &&
                !_lodash["default"].isEqual(val, defaultSchema[key])
              ) {
                modified[key] = val;
              }
            } else if (
      ...
      },
      {
        key: "schema",
        get: function get() {
          return (0, FormioUtils.fastCloneDeep)(
            this.getModifiedSchema(
              _lodash["default"].omit(this.component, "id"),
              this.defaultSchema
            )
          );
        },
      ...
      },
      {
        ...
        value: function t(text) {
          ...
          return (_get2 = _get(
            ...
            "t",
            this
          )).call.apply(_get2, [this, text, params].concat(args));
        },
      },
      {
        key: "labelIsHidden",
      ...
      },
      {
        ...
        value: function transform(type, value) {
          var frameworkTemplates = this.options.template
        ...
        value: function checkTemplate(templates, names, modes) {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done; ) {
              ...
              if (templatesByName) {
                var templateByMode = this.checkTemplateMode(
                  templatesByName,
                  modes
                );
                if (templateByMode) {
      ...
      },
      {
        ...
        value: function sanitize(dirty, forceSanitize, options) {
          ...
          return FormioUtils.sanitize(dirty, {
            sanitizeConfig: _lodash["default"].merge(
              ((_this$options = this.options) === null ||
              _this$options === void 0
                ? void 0
                : _this$options.sanitizeConfig) || {},
              options || {}
            ),
          });
        },
      ...
      },
      {
        ...
        get: function get() {
          ...
          if (
            ...
            _this$root !== void 0 &&
            _this$root.shadowRoot
          ) {
            settings.shadowRoot = this.root.shadowRoot;
          }
          var widget =
            settings && _widgets["default"][settings.type]
              ? new _widgets["default"][settings.type](
                  settings,
                  this.component,
                  this
                )
      ...
      },
      {
        ...
        get: function get() {
          this.options.submissionTimezone =
            this.options.submissionTimezone ||
            _lodash["default"].get(this.root, "options.submissionTimezone");
          ...
          if (
            ...
            (settings.displayInTimezone === "submission" ||
              ((this.options.pdf || this.options.server) &&
                settings.displayInTimezone === "viewer"))
          ) {
      ...
      },
      {
        ...
        value: function loadRefs(element, refs) {
          for (var ref in refs) {
            ...
            var selector =
              isString && refType.includes("scope")
                ? ':scope > [ref="'.concat(ref, '"]')
                : '[ref="'.concat(ref, '"]');
      ...
      },
      {
        ...
        value: function setOpenModalElement(template) {
          this.componentModal.setOpenModalElement(
      ...
      },
      {
        ...
        value: function getModalPreviewTemplate() {
          ...
          if (
            this.hasInput &&
            (_this$component$valid = this.component.validate) !== null &&
            _this$component$valid !== void 0 &&
            _this$component$valid.required &&
            !this.isPDFReadOnlyMode
          ) {
            modalLabel = {
          ...
          return this.renderTemplate("modalPreview", {
            previewText:
              this.getValueAsString(dataValue, {
                modalPreview: true,
      ...
      },
      {
        ...
        value: function render() {
          var children =
            arguments.length > 0 && arguments[0] !== undefined
              ? arguments[0]
              : "Unknown component: ".concat(this.component.type);
          var topLevel =
            arguments.length > 1 && arguments[1] !== undefined
              ? arguments[1]
              : false;
          ...
          if (
            !this.builderMode &&
            !this.previewMode &&
            this.component.modalEdit
          ) {
            return _ComponentModal["default"].render(
              this,
              {
                visible: isVisible,
      ...
      },
      {
        ...
        value: function attachTooltips(toolTipsRefs) {
          var _this6 = this;
          toolTipsRefs === null || toolTipsRefs === void 0
            ? void 0
            : toolTipsRefs.forEach(function (tooltip, index) {
                if (tooltip) {
                  var tooltipAttribute = tooltip.getAttribute("data-tooltip");
                  var tooltipDataTitle = tooltip.getAttribute("data-title");
                  var tooltipText = _this6
                    .interpolate(tooltipDataTitle || tooltipAttribute)
                    .replace(/(?:\r\n|\r|\n)/g, "<br />");
      ...
      },
      {
        ...
        value: function createComponentModal(
          element,
          modalShouldBeOpened,
          currentValue
        ) {
          return new _ComponentModal["default"](
            this,
            element,
            modalShouldBeOpened,
            currentValue
      ...
      },
      {
        ...
        value: function attach(element) {
          if (
            ...
            var modalShouldBeOpened = this.componentModal
              ? this.componentModal.isOpened
              : false;
            var currentValue = modalShouldBeOpened
              ? this.componentModal.currentValue
              : this.dataValue;
            var openModalTemplate =
              this.componentModal && modalShouldBeOpened
                ? this.componentModal.openModalTemplate
                : null;
            this.componentModal = this.createComponentModal(
              element,
              modalShouldBeOpened,
              currentValue
            );
      ...
      },
      {
        ...
        value: function restoreFocus() {
          ...
          var isFocused =
            ((_this$root2 = this.root) === null || _this$root2 === void 0
              ? void 0
              : (_this$root2$focusedCo = _this$root2.focusedComponent) ===
                  null || _this$root2$focusedCo === void 0
              ? void 0
              : _this$root2$focusedCo.path) === this.path;
          if (isFocused) {
            ...
            this.focus(
              (_this$root$currentSel = this.root.currentSelection) === null ||
                _this$root$currentSel === void 0
                ? void 0
                : _this$root$currentSel.index
            );
      ...
      },
      {
        ...
        value: function checkRefresh(refreshData, changed, flags) {
          var changePath = _lodash["default"].get(
            changed,
            "instance.path",
            false
          );
          ...
          if (refreshData === "data") {
            ...
            changePath &&
            (0, FormioUtils.getComponentPath)(changed.instance) ===
              refreshData &&
            changed &&
            changed.instance &&
      ...
      },
      {
        ...
        value: function refresh(value) {
          if (this.hasOwnProperty("refreshOnValue")) {
            this.refreshOnChanged = !_lodash["default"].isEqual(
              value,
              this.refreshOnValue
            );
          } else {
        ...
        value: function getWidgetValueAsString(value, options) {
          ...
          if (Array.isArray(value)) {
            ...
            value.forEach(function (val, index) {
              var widget =
                _this8.refs.input[index] && _this8.refs.input[index].widget;
              if (widget) {
        ...
        value: function itemValue(data) {
          var forceUseValue =
            arguments.length > 1 && arguments[1] !== undefined
              ...
              : false;
          if (
            _lodash["default"].isObject(data) &&
            !_lodash["default"].isArray(data)
          ) {
          ...
          if (Array.isArray(value)) {
            var values = value.map(function (item) {
              return Array.isArray(item)
                ? _this9.itemValueForHTMLMode(item)
                : _this9.itemValue(item);
            });
            return values.join(", ");
          }
      ...
      },
      {
        ...
        value: function createModal(element, attr, confirm) {
          ...
          this.addEventListener(
            dialog.refs.dialogOverlay,
            "click",
            handleCloseClick
          );
          this.addEventListener(
            dialog.refs.dialogClose,
            "click",
            handleCloseClick
          );
          return dialog;
      ...
      },
      {
        key: "className",
        get: function get() {
          var className = this.hasInput
            ? "".concat(this.transform("class", "form-group"), " has-feedback ")
            : "";
          className += "formio-component formio-component-".concat(
            this.component.type,
            " "
          );
      ...
      },
      {
        ...
        get: function get() {
          return this.t(
            this.component.label || this.component.placeholder || this.key,
            {
              _userInput: true,
            }
          );
      ...
      },
      {
        ...
        value: function setContent(
          ...
          if (element instanceof HTMLElement) {
            element.innerHTML = this.sanitize(
              content,
              forceSanitize,
              sanitizeOptions
            );
      ...
      },
      {
        ...
        value: function restoreCaretPosition() {
          ...
          if (
            ...
            _this$root3 !== void 0 &&
            _this$root3.currentSelection
          ) {
            var _this$refs$input;
            if (
              (_this$refs$input = this.refs.input) !== null &&
              _this$refs$input !== void 0 &&
              _this$refs$input.length
            ) {
              ...
              var isInputRangeSelectable = function isInputRangeSelectable(i) {
                return /text|search|password|tel|url/i.test(
                  (i === null || i === void 0 ? void 0 : i.type) || ""
                );
              };
              if (input) {
                if (isInputRangeSelectable(input)) {
                  var _input;
                  (_input = input).setSelectionRange.apply(
                    _input,
                ...
                var lastCharacter =
                  ((_input$value = input.value) === null ||
                  _input$value === void 0
                    ? void 0
                    : _input$value.length) || 0;
                if (isInputRangeSelectable(input)) {
      ...
      },
      {
        ...
        value: function hasClass(element, className) {
          ...
          return _get(
            ...
            "hasClass",
            this
          ).call(this, element, this.transform("class", className));
        },
      },
      {
        key: "addClass",
      ...
      },
      {
        ...
        value: function checkComponentConditions(data, flags, row) {
          ...
          row = row || this.data;
          if (
            !this.builderMode & !this.previewMode &&
            this.fieldLogic(data, row)
          ) {
            this.redraw();
          }
      ...
      },
      {
        ...
        value: function fieldLogic(data, row) {
          ...
          var newComponent = (0, FormioUtils.fastCloneDeep)(
            this.originalComponent
          );
          var changed = logics.reduce(function (changed, logic) {
            var result = FormioUtils.checkTrigger(
              newComponent,
              logic.trigger,
              row,
              data,
              _this11.root ? _this11.root._form : {},
              _this11
            );
            return (
              (result
                ? _this11.applyActions(
                    newComponent,
                    logic.actions,
                    result,
                    row,
          ...
          return actions.reduce(function (changed, action) {
            switch (action.type) {
              case "property": {
                ...
                if (
                  !_lodash["default"].isEqual(
                    _lodash["default"].get(_this12.component, property),
                    _lodash["default"].get(newComponent, property)
                  )
                ) {
                  changed = true;
                }
              ...
              case "value": {
                ...
                if (
                  !_lodash["default"].isEqual(oldValue, newValue) &&
                  !(_this12.component.clearOnHide && !_this12.visible)
                ) {
              ...
              case "mergeComponentSchema": {
                ...
                if (
                  !_lodash["default"].isEqual(_this12.component, newComponent)
                ) {
                  changed = true;
                }
                break;
              ...
              case "customAction": {
                ...
                var _newValue = _this12.evaluate(
                  action.customAction,
                  {
                ...
                if (
                  !_lodash["default"].isEqual(_oldValue, _newValue) &&
                  !(_this12.component.clearOnHide && !_this12.visible)
                ) {
      ...
      {
        key: "setErrorClasses",
        value: function setErrorClasses(
          elements,
          dirty,
          hasErrors,
          hasMessages
          ...
          elements.forEach(function (element) {
            _this14.setElementInvalid(
              _this14.performInputMapping(element),
              false
            );
          });
          ...
          if (hasErrors) {
            ...
            elements.forEach(function (input) {
              _this14.setElementInvalid(
                _this14.performInputMapping(input),
                true
              );
            });
      ...
      },
      {
        ...
        value: function clearOnHide() {
          ...
          if (
            ...
            (!this.rootPristine ||
              this.options.server ||
              (0, FormioUtils.isInsideScopingComponent)(this)) &&
      ...
      },
      {
        ...
        value: function triggerRootChange() {
          if (this.options.onChange) {
            var _this$options2;
            (_this$options2 = this.options).onChange.apply(
              _this$options2,
              arguments
            );
          } else if (this.root) {
            var _this$root4;
            (_this$root4 = this.root).triggerChange.apply(
              _this$root4,
              arguments
            );
          }
      ...
      },
      {
        ...
        value: function addCKE(element, settings, onChange) {
          ...
          settings = _lodash["default"].merge(
            this.wysiwygDefault.ckeditor,
            _lodash["default"].get(
              this.options,
              "editors.ckeditor.settings",
              {}
            ),
            settings
          );
          if (this.component.isUploadEnabled) {
            settings.extraPlugins.push(
              (0, _uploadAdapter.getFormioUploadAdapterPlugin)(
                this.fileService,
                this
              )
            );
          }
          return _Formio.GlobalFormio.requireLibrary(
            "ckeditor",
            isIEBrowser ? "CKEDITOR" : "ClassicEditor",
            _lodash["default"].get(
              this.options,
              "editors.ckeditor.src",
              "".concat(_Formio.GlobalFormio.cdn.ckeditor, "/ckeditor.js")
            ),
            true
          ).then(function () {
            ...
            if (isIEBrowser) {
              ...
              return ClassicEditor.create(element, settings).then(function (
                editor
              ) {
      ...
      },
      {
        ...
        value: function addQuill(element, settings, onChange) {
          var _this15 = this;
          settings = _lodash["default"].isEmpty(settings)
            ? this.wysiwygDefault.quill
            : settings;
          settings = _lodash["default"].merge(
            this.wysiwygDefault.quill,
            _lodash["default"].get(this.options, "editors.quill.settings", {}),
            settings
          );
          ...
          _Formio.GlobalFormio.requireLibrary(
            "quill-css-".concat(settings.theme),
            "Quill",
            [
              {
                type: "styles",
                src: ""
                  .concat(_Formio.GlobalFormio.cdn.quill, "/quill.")
                  .concat(settings.theme, ".css"),
              },
            ],
            true
          );
          ...
          return _Formio.GlobalFormio.requireLibrary(
            ...
            _lodash["default"].get(
              this.options,
              "editors.quill.src",
              "".concat(_Formio.GlobalFormio.cdn.quill, "/quill.min.js")
            ),
            true
          ).then(function () {
            return _Formio.GlobalFormio.requireLibrary(
              ...
              "Quill",
              "".concat(
                _Formio.GlobalFormio.cdn.baseUrl,
                "/quill/quill-table.js"
              ),
              true
            ).then(function () {
              if (!element.parentNode) {
              ...
              if (qlSource) {
                _this15.addEventListener(qlSource, "click", function (event) {
                  ...
                  if (txtArea.style.display === "inherit") {
                    _this15.quill.setContents(
                      _this15.quill.clipboard.convert({
                        html: txtArea.value,
                      })
                    );
                  }
      ...
      },
      {
        ...
        value: function addAce(element, settings, onChange) {
          ...
          settings = _lodash["default"].merge(
            this.wysiwygDefault.ace,
            _lodash["default"].get(this.options, "editors.ace.settings", {}),
            settings || {}
          );
          return _Formio.GlobalFormio.requireLibrary(
            "ace",
            ...
            _lodash["default"].get(
              this.options,
              "editors.ace.src",
              "".concat(_Formio.GlobalFormio.cdn.ace, "/ace.js")
            ),
            true
      ...
      },
      {
        ...
        value: function hasValue(data) {
          return !_lodash["default"].isUndefined(
            _lodash["default"].get(data || this.data, this.key)
          );
        },
      ...
      },
      {
        ...
        value: function splice(index) {
          ...
          if (this.hasValue()) {
            ...
            if (
              _lodash["default"].isArray(dataValue) &&
              dataValue.hasOwnProperty(index)
            ) {
        ...
        get: function get() {
          return (
            ...
            (this.component.defaultValue &&
              !this.isEmpty(this.component.defaultValue)) ||
            this.component.customDefaultValue
          );
        },
      },
          ...
          var checkMask = function checkMask(value) {
            if (typeof value === "string") {
              if (_this16.component.type !== "textfield") {
                ...
                value = (0, _vanillaTextMask.conformToMask)(
                  value,
                  _this16.defaultMask,
                  {
      ...
      },
      {
        ...
        value: function setValueAt(index, value) {
          ...
          if (
            valueMaskInput !== null &&
            valueMaskInput !== void 0 &&
            valueMaskInput.mask &&
            valueMaskInput.mask.textMaskInputElement
          ) {
      ...
      },
      {
        ...
        value: function setDefaultValue() {
          if (this.defaultValue && this.shouldAddDefaultValue) {
            var defaultValue =
              this.component.multiple && !this.dataValue.length
                ? []
                : this.defaultValue;
        ...
        value: function updateComponentValue(value) {
          var flags =
            arguments.length > 1 && arguments[1] !== undefined
              ...
              : {};
          var newValue =
            !flags.resetValue && (value === undefined || value === null)
              ? this.getValue()
              : value;
          ...
          var changed =
            newValue !== undefined
              ? this.hasChanged(newValue, oldValue)
              : false;
          if (changed) {
        ...
        value: function doValueCalculation(dataValue, data, row) {
          ...
          return this.evaluate(
            this.component.calculateValue,
            {
              ...
              data: data,
              row: row || this.data,
              submission: ((_this$root5 = this.root) === null ||
              _this$root5 === void 0
                ? void 0
                : _this$root5._submission) || {
                data: this.rootValue,
              },
            },
            "value"
        ...
        value: function calculateComponentValue(data, flags, row) {
          ...
          if (
            ...
            _lodash["default"].isUndefined(
              _lodash["default"].get(this, "root.data")
            )
          ) {
            return false;
          }
          ...
          var allowOverride = _lodash["default"].get(
            this.component,
          ...
          if (
            ...
            (this.options.readOnly &&
              this.options.pdf &&
              allowOverride &&
              _lodash["default"].get(this.root, "submission._id", false))
          ) {
            return false;
          }
          var dataValue = this.dataValue;
          // Calculate the new value.
          var calculatedValue = this.doValueCalculation(
            dataValue,
            data,
            row,
            flags
          ...
          if (allowOverride) {
            ...
            var newCalculatedValue = this.normalizeValue(
              this.convertNumberOrBoolToString(calculatedValue)
            );
            var previousCalculatedValue = this.normalizeValue(
              this.convertNumberOrBoolToString(this.calculatedValue)
            );
            var normalizedDataValue = this.normalizeValue(
              this.convertNumberOrBoolToString(dataValue)
            );
            var calculationChanged = !_lodash["default"].isEqual(
              previousCalculatedValue,
              newCalculatedValue
            );
            var previousChanged = !_lodash["default"].isEqual(
              normalizedDataValue,
              previousCalculatedValue
            );
            ...
            if (fromSubmission) {
              ...
              this.calculatedValue = (0, FormioUtils.fastCloneDeep)(
                calculatedValue
              );
              return false;
            }
      ...
      },
      {
        ...
        value: function invalidMessage(data, dirty, ignoreCondition, row) {
          ...
          return _lodash["default"]
            .map(_Validator["default"].checkComponent(this, data), "message")
            .join("\n\n");
        },
      ...
      },
      {
        ...
        value: function checkComponentValidity(data, dirty, row) {
          ...
          var _options$async = options.async,
            ...
            silentCheck =
              _options$silentCheck === void 0 ? false : _options$silentCheck;
          if (this.shouldSkipValidation(data, dirty, row)) {
            this.setCustomValidity("");
            return async ? _nativePromiseOnly["default"].resolve(true) : true;
          }
          var check = _Validator["default"].checkComponent(
            this,
            data,
            row,
            true,
          ...
          if (
            (_this$serverErrors = this.serverErrors) !== null &&
            _this$serverErrors !== void 0 &&
            _this$serverErrors.length
          ) {
            validations = check.concat(this.serverErrors);
          }
          return async
            ? validations.then(function (messages) {
                return _this17.setComponentValidity(
                  messages,
                  dirty,
                  silentCheck
                );
        ...
        value: function isEmpty() {
          var value =
            arguments.length > 0 && arguments[0] !== undefined
              ...
              : this.dataValue;
          var isEmptyArray =
            _lodash["default"].isArray(value) && value.length === 1
              ? _lodash["default"].isEqual(value[0], this.emptyValue)
              : false;
          return (
            value == null ||
            value.length === 0 ||
            _lodash["default"].isEqual(value, this.emptyValue) ||
            isEmptyArray
          );
        },
      },
      {
        ...
        value: function isEqual(valueA) {
          ...
          return (
            ...
            _lodash["default"].isEqual(valueA, valueB)
          );
        },
      ...
      },
      {
        ...
        value: function setInputWidgetErrorClasses(inputRefs, hasErrors) {
          if (
            ...
            !(inputRefs !== null && inputRefs !== void 0 && inputRefs.length)
          ) {
            return;
          }
        ...
        value: function setCustomValidity(messages, dirty, external) {
          ...
          if (this.component.multiple) {
            ...
            inputRefsArray.forEach(function (input) {
              _this19.setElementInvalid(
                _this19.performInputMapping(input),
                false
              );
            });
            ...
            invalidInputRefs = inputRefsArray.filter(function (ref) {
              ...
              return (_messages$some = (_messages = messages).some) === null ||
                _messages$some === void 0
                ? void 0
                : _messages$some.call(_messages, function (msg) {
                    var _msg$context;
                    return (
                      (msg === null || msg === void 0
                        ? void 0
                        : (_msg$context = msg.context) === null ||
                          _msg$context === void 0
                        ? void 0
                        : _msg$context.input) === ref
                    );
                  });
            });
          }
          if (messages.length) {
            ...
            !this.error ||
            (this.error && this.error.external === !!external)
          ) {
            if (this.refs.messageContainer) {
              this.empty(this.refs.messageContainer);
            }
      ...
      },
      {
        ...
        value: function shouldSkipValidation(data, dirty, row) {
          ...
          var _ref = this.component || {},
            ...
            validateWhenHidden =
              _ref$validateWhenHidd === void 0 ? false : _ref$validateWhenHidd;
          var rules = [
      ...
      },
      {
        ...
        value: function getRelativePath(path) {
          ...
          var thisPath = this.isInputComponent
            ? this.path
      ...
      },
      {
        ...
        value: function scrollIntoView() {
          ...
          window.scrollTo(
            verticalOnly ? window.scrollX : left + window.scrollX,
            top + window.scrollY
          );
        },
      },
      {
        ...
        value: function focus(index) {
          ...
          if (
            (_this$refs$input2 = this.refs.input) !== null &&
            _this$refs$input2 !== void 0 &&
            _this$refs$input2.length
          ) {
            var _this$component$widge;
            var focusingInput =
              typeof index === "number" && this.refs.input[index]
                ? this.refs.input[index]
                : this.refs.input[this.refs.input.length - 1];
            if (
              ((_this$component$widge = this.component.widget) === null ||
              _this$component$widge === void 0
                ? void 0
                : _this$component$widge.type) === "calendar"
            ) {
      ...
      },
      {
        ...
        get: function get() {
          ...
          if (this.root && this.root._form && this.root._form._id) {
            formio.formUrl = ""
              .concat(formio.projectUrl, "/form/")
              .concat(this.root._form._id);
          }
          return formio;
        },
      },
    ...
    [
      {
        ...
        value: function schema() {
          ...
          return _lodash["default"].merge.apply(
            _lodash["default"],
            [
              {
                /**
...
Component.requireLibrary = function (name, property, src, polling) {
  if (!Component.externalLibraries.hasOwnProperty(name)) {
    ...
    Component.externalLibraries[name].ready = new _nativePromiseOnly["default"](
...
Component.libraryReady = function (name) {
  ...
  return _nativePromiseOnly["default"].reject(
    "".concat(name, " library was not required.")
  );
};
