...
var _Component2 = _interopRequireDefault(
  require("../_classes/component/Component")
);
    ...
    [
      ...
      },
      {
        ...
        get: function get() {
          ...
          if (
            this.component.content.replace(/(<(\/?[^>]+)>)/g, "").trim() ===
            "select"
          ) {
      ...
      },
      {
        ...
        value: function checkRefreshOn(changed) {
          _get(
            _getPrototypeOf(HTMLComponent.prototype),
            "checkRefreshOn",
            this
          ).call(this, changed);
          if (
            ...
            this.element &&
            !_lodash["default"].isUndefined(changed) &&
            ((_lodash["default"].isBoolean(changed) && changed) ||
              !_lodash["default"].isEmpty(changed)) &&
      ...
      },
      {
        ...
        get: function get() {
          var _this$root;
          return (
            ((_this$root = this.root) === null || _this$root === void 0
              ? void 0
              : _this$root.submissionReady) || Promise.resolve()
          );
        },
      },
      {
    ...
    [
      {
        ...
        value: function schema() {
          ...
          return _Component2["default"].schema.apply(
            _Component2["default"],
            [
              {
                label: "HTML",
      ...
      },
      {
        ...
        get: function get() {
          return {
            ...
            weight: 0,
            documentation:
              "/userguide/form-building/layout-components#html-element",
            showPreview: false,
