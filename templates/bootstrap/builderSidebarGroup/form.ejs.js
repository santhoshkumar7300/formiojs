...
exports.default = function (ctx) {
  ...
  __p +=
    ...
    '"\n        aria-controls="group-' +
    ((__t = ctx.groupKey) == null ? "" : __t) +
    '"\n        ref="sidebar-anchor"\n        style="border: none; border-bottom: 1px solid #ddd; width: 100%; text-align: left; padding: 10px; background-color: #f8f9fa; transition: all 0.3s ease;"\n      >\n        ' +
    ((__t = ctx.t(ctx.group.title, { _userInput: true })) == null ? "" : __t) +
    '\n      </button>\n    </h5>\n  </div>\n  <div\n    id="group-' +
    ((__t = ctx.groupKey) == null ? "" : __t) +
    '"\n    class="collapse ' +
    ...
    '"\n    aria-labelledby="heading-' +
    ((__t = ctx.groupKey) == null ? "" : __t) +
    '"\n    ref="sidebar-group"\n    style="transition: all 0.3s ease; border-bottom: 1px solid #ddd; padding: 10px; background-color: #fff;"\n  >\n    <div id="group-container-' +
    ((__t = ctx.groupKey) == null ? "" : __t) +
    '" class="d-grid gap-1 no-drop p-2 w-100" ref="sidebar-container">\n      ';
  if (ctx.group.componentOrder.length || ctx.subgroups.length) {
    __p += "\n        ";
